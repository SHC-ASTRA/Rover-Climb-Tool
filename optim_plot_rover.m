function stop = optim_plot_rover(x,wheel_radius)
...
suspension_vert_len = x(4);

suspension_design_x = [-wheelbase_length/2, -wheelbase_length/2, -suspension_trap_len/2, suspension_trap_len/2, wheelbase_length/2, wheelbase_length/2]; % Distance from center of rover, negative towards rear wheel, positive towards front
suspension_design_y = [0,suspension_vert_len,suspension_height, suspension_height, suspension_vert_len, 0]; % Height above wheel centerline, not above ground = [0,suspension_height, suspension_height, 0]; % Height above wheel centerline, not above ground
